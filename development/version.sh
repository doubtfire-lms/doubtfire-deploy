...
# The current version is used to create the base name for development containers.
...
export CURRENT_API_VERSION=7.0
export CURRENT_WEB_VERSION=7.0
export CURRENT_DEV_VERSION=7.0
