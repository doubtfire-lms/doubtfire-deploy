...
We welcome additions and extensions to OnTrack that help progress our goal of supporting student learning through frequent formative feedback and delayed summative assessment.

This guide provides high-level details on how to contribute to the OnTrack repositories.

## Table of Contents

- [Contributing to OnTrack](#contributing-to-doubtfire)
  - [Table of Contents](#table-of-contents)
  - [Getting started](#getting-started)
    - [Development Containers](#development-containers)
    - [Working with Docker Compose](#working-with-docker-compose)
  - [Forking workflow](#forking-workflow)
    - [About the OnTrack Branch Structure](#about-the-doubtfire-branch-structure)
...
Development of OnTrack uses Docker containers to remove the need to install a range of native tools used within the project. The OnTrack Deploy project helps when working across multiple components of the OnTrack application, and is used for testing and publishing versions for deployment.
...
- The **development** folder in the doubtfire deploy project contains separate docker compose setups for working with combinations of projects:
  ...
  - The **docker-compose.full.yml** contains a setup with all of the containers needed to run OnTrack with overseer. This requires access to the overseer repository. You can run this using **run-full.sh**
...
6. Open a web browser and navigate to:
   ...
   - When you bring up the _doubtfire-web_ project, it will run `npm install` to setup the node*modules. If you change the package.json in \_doubtfire-web* you can just restart the container to update the node modules.

## Forking workflow

We follow a [Forking workflow](https://www.atlassian.com/git/tutorials/comparing-workflows/forking-workflow) when developing on any OnTrack repository.

### About the OnTrack Branch Structure
